 ...
 *
 */
public abstract class BDCPS_1 {

    public static BDCPS getInstance() {
        //TODO: implement
        return null;
    }
    ...
    public abstract byte[][] signcrypt(byte[] message, byte[] receiverId, byte[] receiverPublicValue) //throws CipherException
    ;

    public abstract byte[] unsigncrypt(byte[][] cryptogram, byte[] senderId, byte[] senderPublicValue) //throws InvalidMessageException, CipherException
    ;
