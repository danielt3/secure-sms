...
public class BNParams {
    ...
    /**
     * Compute BN parameter for a given field size, which must be a multiple of
     * 8 between 56 and 512.
     *
    ...
    public BNParams(int fieldBits) {
        ...
        case 96:
            ...
            break;
        case 108:
            u = new BigInteger("11000000000100000100001011", 2); // Hamming weight 7
            break;
        case 112:
