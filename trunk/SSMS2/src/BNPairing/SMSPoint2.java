...
public class SMSPoint2 {
     ...
     */
    SMSPoint2(SMSCurve2 E, SMSField2 x, int yBit) {
        if (x.isZero()) {
        ...
        this.E = E;
        this.x = x;
        this.y = (beta.re.testBit(0) == ((yBit & 1) == 1)) ? beta : beta.negate();
        this.z = E.Fp2_1; // normalized
        this.m = E.Fp2_0;
    }
    ...
    public SMSPoint2 normalize() {
        ...
        return new SMSPoint2(E, x.multiply(zinv2), y.multiply(zinv3), E.Fp2_1);
    }
    ...
    public SMSPoint2 twice(int n) {
        ...
        SMSField2 t1, t2, t3, t4, t5, M = E.Fp2_0;
        t1 = x;
        t2 = y;
        t3 = z;
        while (n-- > 0) {
