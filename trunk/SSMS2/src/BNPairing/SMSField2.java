...
public class SMSField2 {
    ...
    public SMSField2 inverse() throws ArithmeticException {
        ...
        return new SMSField2(sms, re.multiply(d), sms.p.subtract(im).multiply(d), true);
    }
    ...
    public SMSField2 multiplyI() {
        return new SMSField2(sms, sms.p.subtract(im), re, false);
    }
    ...
    public SMSField2 sqrt() {
        ...
        r2 = r2.multiplyI();
        //SMSField2 sqrtI = new SMSField2(sms, sms.invSqrtMinus2, sms.p.subtract(sms.invSqrtMinus2), false); // sqrt(i) = (1 - i)/sqrt(-2)
