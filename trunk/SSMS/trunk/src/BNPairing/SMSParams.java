...
public class SMSParams {
    ...
    static int nextValid(int fieldSize) {
        ...
        //*/
            ...
            return 160;
        } else if (fieldSize < 175) {
            return 175;
        /*
        } else if (fieldSize < 183) {
            return 183;
        //*/
    ...
    public SMSParams(int fieldBits) {
        ...
        case 104: // D = -33960243
            ...
            break;
        case 111: // D = -160090939
            t = new BigInteger("41080526112085095");
            b = new BigInteger("987402190949439425508125144353462");
            y = new BigInteger("1315099287787326381492152378136560");
            xt = new SMSField2(this, // 1
                new BigInteger("816913836280796601566016487939581"),
                new BigInteger("418717176312006218281916184677950"),
                false);
            yt = new SMSField2(this,
                new BigInteger("86271864102482765407736468150701"),
                new BigInteger("966709740228319263113887235231954"),
                false);
            sigma = new BigInteger("268813820807097273871420426727392");
            break;
        case 117: // D = -462403
        ...
        case 165: // D = -397700587
            ...
            t = new BigInteger("-6392649579719506343810393");
            b = new BigInteger("");
            y = new BigInteger("");
            xt = new SMSField2(this,
                new BigInteger(""),
            ...
            yt = new SMSField2(this,
                ...
                new BigInteger(""),
                false);
            sigma = new BigInteger("16456750585632289823536501332403074678761619725458");
            break;
        //*/
        case 175: // D = -145196139
            t = new BigInteger("186004802762641436831269975");
            b = new BigInteger("15232416312872262851272061463711879185230287390950721");
            y = new BigInteger("18740922651976616004593499864506484405663298376810220");
            xt = new SMSField2(this,
                new BigInteger("27739559451150435515399250849780067536211632116897470"),
                new BigInteger("5430332720613044912026668189707956993119468238063162"),
                false);
            yt = new SMSField2(this,
                new BigInteger("21631965670190443236519519249168338770956306005213303"),
                new BigInteger("33791610699843583411327243928979119953400654606912748"),
                false);
            sigma = new BigInteger("17901432195811325279983727476460372504295839984300536");
            break;
        /*
        case 183: // D = -674634067
            t = new BigInteger("3097822906918880386843134447");
            b = new BigInteger("3542493504312477825872307791700788386966741687336459946");
            y = new BigInteger("2967635290211399571951527929048059215360133498844153140");
            xt = new SMSField2(this, // 1
                new BigInteger("4073066842529338368454313942612793547195419046880650060"),
                new BigInteger("7885189073226489527766327025578612061480218168377182380"),
                false);
            yt = new SMSField2(this,
                new BigInteger("3356261058966642424306236263797159275145863222682227773"),
                new BigInteger("6387342663983065021618880949395577216741086728636144532"),
                false);
        	sigma = new BigInteger("-3862729349931949514257603168800527906754701297271296301");
            break;
        //*/
...
*** Found one - 324 bits
 D= 297479891
 p= 24328853625436608701950164977024013256048621623056321779846474703157627236316111630251995960227931
NP= 24328853625436608701950164977024013256048621623051389351070969008265287464247848416497510147956837
    (a 324-bit prime) !
