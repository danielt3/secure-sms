...
public class BDCPSParameters {
    ...
    public final SMSField4 g;
    public final BigInteger N;
    public final SMSCurve E; //G1 ?
    public final SMSCurve2 E2; //G2 ?
    //GT ? Acho que não precisa nunca conhecer a curva
    public final SMSPairing PAIR;
    ...
    private BDCPSParameters(int k) {
        ...
        byte[] pPubBytes; // Na fora comprimida
