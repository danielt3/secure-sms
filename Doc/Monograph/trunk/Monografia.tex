...
\subsection{Cenário} %Falar dos limitantes, processamento e tamanho de mensagem pequenos
...
\section{Discussão}
\subsection{Preliminares teóricas}% (assunto geral: curvas elípticas, emparelhamento, protocolos, conceitos, etc)
\subsection{Alternativas existentes}% (RSA, coisas mobile)
\subsection{Revisão literatura} %????
\section{MIOLO}
...
\section{Resultados}% (tabelas, etc, os objetivos foram alcançados? Testes, benchmarks)
\section{Conclusão}
\subsection{Analisar resultados}
\subsection{Possíveis desenvolvimentos futuros}% (ordenar artigos)
\section{Referências}% (falar q gerou artigo e menção honrosa)
