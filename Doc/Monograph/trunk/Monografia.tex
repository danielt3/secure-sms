...
O Apêndice \ref{app:desempenho} apresenta gráficos e tabelas com todos os dados de desempenho obtidos.
...
\begin{table}[h]\centering
\caption{Medida de tempo Signcrypt x tamanho da mensagem} \label{tab:bdcps176final}
\begin{tabular}{cccccc}\hline
