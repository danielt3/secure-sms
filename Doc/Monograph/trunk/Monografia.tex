...
Como inicialmente desejávamos um nível de segurança equiparável ao do RSA, foi escolhido o número 176 como tamanho de chave, pois este fornece um nível de segurança de $176/2 = 88$ bits\footnote{Apesar de termos escolhido este valor padrão, a aplicação pode ser facilmente alterada para trabalhar com outros valores permitidos pela curva escolhida. }, ou seja, um pouco superior ao nível de segurança do RSA-1024, que tem o valor $80$. %TODO: colocar o valor, e citar. Geovs tem o link, acho...
