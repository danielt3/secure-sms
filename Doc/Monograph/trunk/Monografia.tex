...
\begin{abstract}
This work consists of the specification, design and implementation of a system that guarantees security services while exchanging SMS between mobile phone devices. Throughout this monograph, we are going to present aspects of our solution, metrics, an innovative cryptographic scheme that made the implementation possible, specification of the system and performance test results.
\end{abstract}
