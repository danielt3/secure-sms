...
%CÃ³digo para exibir layout antes de cada seÃ§Ã£o
%\AtBeginSubsection[]
\AtBeginSection[]
{
  \begin{frame}<beamer>
...
\begin{frame}{Esquema de segurança desenvolvido}
...
\item Publicação de artigo no SBSEG'08 definindo o novo esquema
\item Publicação de artigo no WTICG'08 sobre o nosso projeto de formatura (menção honrosa)
\end{itemize}
...
\item Implementação de protocolo de mensagens
\item Implementação de persistência: Floggy
\end{itemize}
\end{frame}
...
\caption{Testes com o novo esquema (chaves de 127 bits) e comparaï¿½ï¿½o com o RSA}\label{tab:bdcps127}
\begin{tabular}{cccccc}\hline
Operaï¿½ï¿½o                          & Nokia 6275 (s)   &  Sony Ericsson W200i (s) \\\hline
Private-Key-Extract               & 2,63                   &  0,93                          \\\hline
Validação de chave pública        & 10,50                  &  3,35                          \\\hline
Encripta\c{c}\~{a}o               & 0,57                   &  0,21                          \\\hline
Decripta\c{c}\~{a}o               & 0,80                   &  0,29                          \\\hline
...
\begin{itemize}[<+->]
\item Projeto motivou a criação de um esquema criptográfico inovador
\item Solução implementada com sucesso, alta portabilidade
%TODO: alguém põe mais
\end{itemize}
