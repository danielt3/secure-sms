...
\end{description}
\item Aus\^{e}ncia de uma solu\c{c}\~{a}o criptográfica universalmente adotada.
...
\item Chaves menores para um nível de segurança compatível
...
\item Implementação da interface gráfica
\end{itemize}
\end{frame}
...
\item Possibilidade de comercialização para bancos, operadoras, empresas,etc.
